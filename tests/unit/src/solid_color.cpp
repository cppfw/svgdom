...
const tst::set set("solid_color", [](tst::suite& suite){
	...
	suite.add(
		"parse_solid_color_different_color_formats",
		[](){
	...
	suite.add(
		"parse_solid_color_not_specified",
		[](){
			std::string_view svg =
				R"xxx(
	...
	suite.add(
		"parse_solid_color_from_style_attribute",
		[](){
			std::string_view svg =
				R"xxx(
				<svg xmlns="http://www.w3.org/2000/svg">
